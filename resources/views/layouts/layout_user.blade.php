...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('img/MainImg/image.png') }}" type="image/jpg">
    <link rel="shortcut icon" href="{{ asset('img/MainImg/image.png') }}" type="image/jpg">
  ...
  <body>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="{{ request()->is('single-product') ? 'active' : '' }}">
                            <a href="{{ route('single-product') }}">Single product</a>
                        </li>
    ...
    <!-- Hiển thị content(nội dung của trang) -->
    @yield('content')
    <!-- Phần footer -->
