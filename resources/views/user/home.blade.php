            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                                ...
                                <a href="TopSeller" class="wid-view-more">View All</a>
                                    ...
                                    {{-- {{ dd($topseller) }} --}}
                                        ...
                                        <div class="single-wid-product">
                                            ...
                                            <a href="{{ route('product.show', ['MaSanPham' => $product->MaSanPham]) }}"><h2>{{ $product->TenSanPham }}</h2></a>
                                ...
                                @if (!empty($recentProducts))
                                    @foreach ($recentProducts as $sp)
                                        <div class="single-wid-product">
                                            ...
                                            <h2><a href="{{ route('product.show', ['MaSanPham' => $sp->MaSanPham]) }}">{{ $sp->Ten }}</a></h2>
                        ...
                        <div class="col-md-4">
                            <div class="single-product-widget">
                                <h2 class="product-wid-title">Top news</h2>
                                <a href="{{ route('recently.viewed') }}" class="wid-view-more">View All</a>

                                @if (!empty($topNew))
                                    @foreach ($topNew as $sp)
                                        <div class="single-wid-product">
                                            <a href="{{ route('product.show', ['MaSanPham' => $sp->MaSanPham]) }}">
                                                <img src="{{ asset('img/products/'.$sp->HinhAnh) }}" alt="{{ $sp->Ten }}" class="product-thumb">
                                            </a>
